# Implement vision functions using ViLD
import cv2
...
def load_clip_model(model_name="ViT-B/32"):
    # This function is used to load a clip model
    # it returns the model instance and its preprocessor
    # it also prints the models parameter count
    ...
    # returns the clip mdoel and its preprocessor
    return clip_model, clip_preprocess

clip_model, clip_process = load_clip_model()

numbered_categories = [{"name": str(idx), "id": idx,} for idx in range(50)]
numbered_category_indices = {cat["id"]: cat for cat in numbered_categories}

# define the flags used in configuring the application
FLAGS = {
